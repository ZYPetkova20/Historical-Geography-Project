...
let footerBackground = document.getElementById('footer-background');
...
if(dark){
    ...
    footerBackground.src = "../../dist/images/footerBackgroundDarkMode.png";
    button.checked = true;
}
else{
    ...
    footerBackground.src = "../../dist/images/footerBackground.png";
